...
ssh -p59522 -tt   root@$line  >>flume-start-all.log << EOF
...
sed -i '/root\|fi\|flume\|name\|done\|exit\|logout\|Last\|echo\|do/d' flume-start-all.log
dos2unix flume-start-all.log
exit
